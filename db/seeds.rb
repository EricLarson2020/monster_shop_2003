...
a = Merchant.create(name: "a", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
b = Merchant.create(name: "b", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
c= Merchant.create(name: "c", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
#bike_shop items
...
tennis_ball = a.items.create!(name: "Tennis Ball", description: "Great ball!", price: 5, image: "http://lovencaretoys.com/image/cache/dog/tu-toy-dog-pull-9010_2-800x800.jpg", inventory: 40)
racket = b.items.create!(name: "Tennis Racket", description: "Great Tennis Racket!", price: 200, image: "http://lvencaretoys.com/image/cache/dog/tu-toy-dog-pull-9010_2-800x800.jpg", inventory: 10)
bell = .items.create!(name: "Bell", description: "They will hear you comming", price: 30, image: "https://www.ri.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 9)
helmet = c.items.create!(name: "Helmet", description: "Keep that head of yours safe", price: 150, image: "https://www.ri.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 32)
