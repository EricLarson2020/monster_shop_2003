...
RSpec.describe "As an Admin" do
  it "I can see all of a merchants items with info and status" do
    dog_shop = Merchant.create!(name: "Brian's Dog Shop", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
    admin = User.create!({ name: "Jack", address: "333 Jack Blvd", city: "Denver", state: "Colorado", zip: 83243, email: "847@hotmail.com", password: "3455", password_confirmation: "3455", role: 2})
    ...
    visit "/login"
    fill_in :email, with: "847@hotmail.com"
  ...
  it "I can click link to change active status to inactive" do
    dog_shop = Merchant.create!(name: "Brian's Dog Shop", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
    admin = User.create!({ name: "Jack", address: "333 Jack Blvd", city: "Denver", state: "Colorado", zip: 83243, email: "678@hotmail.com", password: "3455", password_confirmation: "3455", role: 2, merchant_id: dog_shop.id})
    ...
    visit "/login"
    fill_in :email, with: "678@hotmail.com"
    fill_in :password, with: "3455"
    click_on "Submit"
    visit "/admin/merchants/#{dog_shop.id}/items"
  ...
  it "I can click link to change inactive status to active" do
    dog_shop = Merchant.create!(name: "Brian's Dog Shop", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
    admin = User.create!({ name: "Jack", address: "333 Jack Blvd", city: "Denver", state: "Colorado", zip: 83243, email: "hellos@hotmail.com", password: "3455", password_confirmation: "3455", role: 2, merchant_id: dog_shop.id})
    pull_toy = dog_shop.items.create!(name: "Pull Toy", description: "Great pull toy!", price: 10, image: "http://lovencaretoys.com/image/cache/dog/tug-toy-dog-pull-9010_2-800x800.jpg", inventory: 32, active?: true)
    ...
    visit "/login"
    fill_in :email, with: "hellos@hotmail.com"
    fill_in :password, with: "3455"
    click_on "Submit"
    visit "/admin/merchants/#{dog_shop.id}/items"
