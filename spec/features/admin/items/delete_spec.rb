...
RSpec.describe "As a Admin employee, when I visit my items page" do
  it "I can delete an item if it has never been ordered" do
    ...
    admin = User.create!({ name: "Jack", address: "333 Jack Blvd", city: "Denver", state: "Colorado", zip: 83243, email: "bobys@hotmail.com", password: "3455", password_confirmation: "3455", role: 2, merchant_id: dog_shop.id})
    ...
    visit "/login"
    fill_in :email, with: "bobys@hotmail.com"
