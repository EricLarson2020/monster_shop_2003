...
RSpec.describe 'Cart show' do
  ...
  describe "When I haven't added anything to my cart" do
    describe "and visit my cart show page" do
      ...
      it "user can increase/decrease quantity from cart" do
        mike = Merchant.create(name: "Mike's Print Shop", address: '123 Paper Rd.', city: 'Denver', state: 'CO', zip: 80203)
        meg = Merchant.create(name: "Meg's Bike Shop", address: '123 Bike Rd.', city: 'Denver', state: 'CO', zip: 80203)
      ...
      it "user can decrease quantity from cart" do
        mike = Merchant.create(name: "Mike's Print Shop", address: '123 Paper Rd.', city: 'Denver', state: 'CO', zip: 80203)
        meg = Merchant.create(name: "Meg's Bike Shop", address: '123 Bike Rd.', city: 'Denver', state: 'CO', zip: 80203)
      ...
      it "when user decreases to 0 item is removed from cart" do
        mike = Merchant.create(name: "Mike's Print Shop", address: '123 Paper Rd.', city: 'Denver', state: 'CO', zip: 80203)
        meg = Merchant.create(name: "Meg's Bike Shop", address: '123 Bike Rd.', city: 'Denver', state: 'CO', zip: 80203)
        ...
        within "#cart-item-#{tire.id}" do
          ...
          click_on 'Update Quantity'
          fill_in 'quantity_decrease', with: "6"
          click_on 'Decrease Quantity'
          click_on 'Decrease Quantity'
        end
